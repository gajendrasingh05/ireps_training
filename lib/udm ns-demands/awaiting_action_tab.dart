...
class AwaitingActionTab extends StatefulWidget {
  const AwaitingActionTab({super.key});

  @override
  State<AwaitingActionTab> createState() => _AwaitingActionTabState();
}

class _AwaitingActionTabState extends State<AwaitingActionTab> {
  ...
  void _submitForm() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => const NSDemandAwaitingScreen()),
    );
  }
...
class NSDemandAwaitingScreen extends StatefulWidget {
  const NSDemandAwaitingScreen({super.key});

  @override
  State<NSDemandAwaitingScreen> createState() =>
      _NSDemandAwaitingScreenState();
}

class _NSDemandAwaitingScreenState extends State<NSDemandAwaitingScreen> {
  ...
  List<DemandItem> get demandItems => [
    DemandItem(
      ...
      itemDetails:
          'Item No.1: OFFICE CHAIR ....[Qty: 10 Numbers]',
      valueMinApprovalLevel: '₹1,524,500/- SAG',
