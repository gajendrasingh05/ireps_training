...
class _UserHomeScreenState extends State<UserHomeScreen> with TickerProviderStateMixin {
  ...
  final Map<String, String> _translations = {
    ...
    'Stock Item History': 'स्टॉक आइटम इतिहास पत्रक',
    ...
    'Stocking Proposal' : 'स्टॉकिंग प्रस्ताव सारांश',
    'Warranty Rejection' : 'वारंटी अस्वीकृति रजिस्टर',
      ...
      child: Material(
        ...
        child: InkWell(
          onTap: () {
            ...
            else if (item.title == 'Stores Depot' || item.title == 'भण्डार डिपो') {
              Navigator.push(context, MaterialPageRoute(builder: (context) => StoreStkDepotRightSideDrawer()));
            }
            else if (item.title == 'Rejection/Warranty' || item.title == 'अस्वीकृति/वारंटी') {
              Navigator.of(context).pushNamed(WarrantyRejectionScreen.routeName);
            }
            else if (item.title == 'NS Demand Summary' || item.title == 'एनएस डिमांड सारांश') {
              Navigator.of(context).pushNamed(NSDemandSummaryScreen.routeName);
            }
            else if (item.title == 'Warranty Complaint' || item.title == 'वारंटी शिकायत सारांश') {
              Navigator.of(context).pushNamed(WarrantyComplaintDropdown.routeName);
            }
            else if (item.title == 'CRN Summary' || item.title == 'सीआरएन सारांश') {
              Navigator.of(context).pushNamed(CrnSummaryScreen.routeName);
            }
            else if (item.title == 'Stocking Proposal' || item.title == 'स्टॉकिंग प्रस्ताव सारांश') {
              Navigator.of(context).pushNamed(StockingProposalSummaryScreen.routeName);
            }
            else if (item.title == 'Warranty Rejection' || item.title == 'वारंटी अस्वीकृति रजिस्टर') {
              Navigator.of(context).pushNamed(WarrantyRejectionRegisterScreen.routeName);
            }
            else if (item.title == 'CRC Summary' || item.title == 'सीआरसी सारांश') {
              Navigator.of(context).pushNamed(CrcSummaryScreen.routeName);
            }
