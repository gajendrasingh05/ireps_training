...
class _ResilienceDashboardState extends State<ResilienceDashboard> {
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                _buildStatusIndicator('Transactions', Colors.green, '85', 'Active'),
                _buildStatusIndicator('Integration', Colors.green, '100%', 'Operational'),
                _buildStatusIndicator('Server', Colors.green, '99.9%', 'Uptime'),
              ],
            ),
          ],
        ),
  ...
  Widget _buildStatusIndicator(String title, Color color, String value, String subtitle) {
    return Column(
      children: [
        Icon(
          Icons.check_circle,
      ...
      children: [
        ...
        GridView.count(
          ...
          children: [
            ...
            // Add these two new metric cards
            _buildMetricCard(
              'Payment Transactions\n(module wise)',
              'In last 15 mins',
              '6',
    ...
    return SingleChildScrollView(
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            _buildSectionHeader('Transaction & Workflow Metrics'),
            const SizedBox(height: 16),
            _buildTransactionMetricsTable(),
            const SizedBox(height: 24),
  ...
  Widget _buildSectionHeader(String title) {
    return Column(  // Changed from Row to Column to stack elements vertically
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
          title,
        ...
        Row(
          children: [
            OutlinedButton.icon(
              icon: const Icon(Icons.file_download_outlined, size: 16),  // Smaller icon
              label: const Text('Export', style: TextStyle(fontSize: 12)),  // Smaller text
            ...
            const SizedBox(width: 8),
            OutlinedButton.icon(
              icon: const Icon(Icons.filter_list, size: 16),  // Smaller icon
              label: const Text('Filter', style: TextStyle(fontSize: 12)),  // Smaller text
              style: OutlinedButton.styleFrom(
                padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),  // Reduced padding
                minimumSize: Size.zero,  // Allow button to be smaller
                tapTargetSize: MaterialTapTargetSize.shrinkWrap,  // Tighter touch target
        ...
        child: SingleChildScrollView(
          ...
          child: DataTable(
            ...
            columns: const [
              ...
              DataColumn(label: Text('Today', style: TextStyle(fontWeight: FontWeight.bold))),
              DataColumn(label: Text('MTD', style: TextStyle(fontWeight: FontWeight.bold))),
              DataColumn(label: Text('Status', style: TextStyle(fontWeight: FontWeight.bold))),
            ],
            rows: [
              _buildDataRow('Tenders Published', '12', '48', Colors.green),
              _buildDataRow('Tenders Opened', '8', '32', Colors.green),
              _buildDataRow('Tenders Decided', '5', '26', Colors.green),
              _buildDataRow('Payment Transactions', '27', '93', Colors.green),
              _buildDataRow('Issues/Receipt in UDM', '18', '67', Colors.orange),
              _buildDataRow('Demands Generated', '22', '105', Colors.green),
              _buildDataRow('Purchase Orders Issued', '15', '156', Colors.green),
            ],
          ),
        ),
      ),
  ...
  DataRow _buildDataRow(String metric, String today, String mtd, Color statusColor) {
    return DataRow(
      cells: [
          ...
          Row(
            children: [
              ...
              Text(
                ...
                statusColor == Colors.orange ? 'Attention' : 'Critical',
              ),
            ],
          ),
        ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            _buildIntegrationItem('Finance System', true, '5 min ago'),
            const Divider(),
            _buildIntegrationItem('Inventory Management', true, '15 min ago'),
            const Divider(),
            _buildIntegrationItem('Railways ERP', true, '30 min ago'),
            const Divider(),
            _buildIntegrationItem('Vendor Portal', true, '1 hour ago'),
            const Divider(),
            _buildIntegrationItem('Payment Gateway', true, '2 hours ago'),
          ],
        ),
      ),
    );
  ...
  Widget _buildIntegrationItem(String system, bool isConnected, String lastSync) {
    return Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                const Text(
                  'Pending/Failed Integration Jobs',
                  style: TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.bold,
                  ),
            ...
            ListView(
              ...
              physics: const NeverScrollableScrollPhysics(),
              children: [
                _buildJobItem('Payment Sync', 'Failed', Colors.red, '10:15 AM'),
                _buildJobItem('Vendor Update', 'Pending', Colors.orange, '11:30 AM'),
              ],
            ),
          ],
        ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            _buildServiceItem('Email Services', true),
            const Divider(),
            _buildServiceItem('SMS Services', true),
            const Divider(),
            _buildServiceItem('Payment Gateway', true),
            const Divider(),
            _buildServiceItem('DR data Sync', true),
            const Divider(),
            _buildServiceItem('PKI Services', true),
            const Divider(),
            _buildServiceItem('GST Services', true),
            const Divider(),
            _buildServiceItem('Document Upload', true),
          ],
        ),
      ),
    );
              ...
              children: [
                ...
                RichText(
                  text: TextSpan(
                    ...
                    children: const [
                      TextSpan(text: 'Last updated: May 13, 2025, '),
                      TextSpan(
                        text: '10:45 AM',
                        style: TextStyle(fontWeight: FontWeight.bold),
                      ),
